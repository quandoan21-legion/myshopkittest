...
namespace MyShopKit\Insight\Clicks\Database;

class ClickStatisticTbl
{
    private static string $customerShopsTbl='customer_shops';
    public static string $tblName = MYSHOPKIT_PREFIX . 'click_statistic';
    ...
    public function createTable()
    {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS $tblName(
			...
			FOREIGN KEY (shopID) REFERENCES $customerShopsTbl(ID) ON DELETE CASCADE,
			PRIMARY KEY (ID)
		) $charsetCollect";
