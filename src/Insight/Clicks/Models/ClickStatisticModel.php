...
namespace MyShopKit\Insight\Clicks\Models;
...
class ClickStatisticModel
{
     ...
     * @return bool
     */
    public static function isClickedToday($shopID, $postID): bool
    {
        global $wpdb;
     ...
     * @param array{ID: int,field: string} $aData
     */
    public static function getIDWithPostIDAndShopID($shopID, $postID)
    {
        global $wpdb;
